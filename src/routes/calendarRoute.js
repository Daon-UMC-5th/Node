...
// 날짜별 진료 목록 조회 
calendarRouter.get("/consultation/:id", calendarController.viewConsultation);
// 날짜별 진료 목록 등록
calendarRouter.post("/consultation/:date",calendarController.registerConsultation);
// 날짜별 진료 목록 삭제
calendarRouter.delete("/consultation/:id", calendarController.deleteConsultation);
// 날짜별 진료 목록 수정
calendarRouter.put("/consultation/:id", calendarController.updateConsultation);
...
calendarRouter.get("/medication/:id", calendarController.viewMedication);
// 날짜별 복용 목록 등록
calendarRouter.post("/medication/:when/:date",calendarController.registerMedication);
// 날짜별 복용 목록 삭제 
calendarRouter.delete("/medication/:id", calendarController. deleteMedication);
// 날짜별 복용 목록 수정 
calendarRouter.put("/medication/:id", calendarController.updateMedication);
