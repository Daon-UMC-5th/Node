...
// 진료기록 조회
const getConsultationSQL = "select * from consultation where consultation_id=?";
module.exports.getConsultationSQL = getConsultationSQL;

// 진료기록 삭제
const deleteConsultationSQL = "delete from consultation where consultation_id=?";
module.exports.deleteConsultationSQL = deleteConsultationSQL;

// 진료기록 수정
const updateConsultationSQL = "update consultation set hospital=?, content=?, alarmed_at=?, updated_at=NOW() where consultation_id=?";
...
// 복용기록 아침/점심/저녁 별 조회
const getMedicationSQL = "select * from medication where medication_id=?";
...
// 복용기록 삭제 
const deleteMedicationSQL = "delete from medication where medication_id=?";
module.exports.deleteMedicationSQL = deleteMedicationSQL;

// 복용기록 수정
const updateMedicationSQL = "update medication set medicine=?, alarmed_at=?, alarm_days=?, repeat_status=?, updated_at=NOW() where medication_id=?";
